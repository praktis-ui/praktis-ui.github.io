import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n,t as r}from"./Modal-QgpmzswK.js";import{t as i}from"./jsx-runtime-DeHZSEgm.js";import{Oc as a,Sc as o,t as s}from"./icons-B1LEmBjt.js";import{n as c,t as l}from"./headerStoryData-TYOh7mx6.js";import{c as u,i as d,n as f,o as p,r as m,s as h,t as g}from"./HeaderParts-CZoLHyoV.js";import{n as _,t as v}from"./Header-Bem91qBQ.js";function y({logo:e=`setl-group`,withModuleName:t=!0,withMenu:n=!0,withActions:i=!0,withAppButton:s=!0,compactAccount:c=!1}){let[u,_]=(0,b.useState)(`objects`),[y,S]=(0,b.useState)(null),[C,w]=(0,b.useState)(!1);return(0,x.jsxs)(T,{children:[(0,x.jsx)(v,{logo:e===`нет`?void 0:e,moduleName:t?`Сервис КС`:void 0,onModuleClick:()=>S(`название модуля`),menu:n&&[(0,x.jsx)(p,{icon:(0,x.jsx)(o,{}),label:`Объекты`,active:u===`objects`,onClick:()=>_(`objects`)},`objects`),(0,x.jsx)(p,{icon:(0,x.jsx)(a,{}),label:`Задачи`,dot:`red`,active:u===`tasks`,onClick:()=>_(`tasks`)},`tasks`)],actions:i&&(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(d,{label:`Загрузки`,icon:(0,x.jsx)(g,{}),status:`loading`,onClick:()=>S(`Загрузки`)}),(0,x.jsx)(d,{label:`Задачи`,icon:(0,x.jsx)(h,{}),count:`3`,onClick:()=>S(`Задачи`)}),(0,x.jsx)(d,{label:`Уведомления`,count:`99+`,countColor:`red`,onClick:()=>S(`Уведомления`)})]}),appButton:s&&(0,x.jsx)(m,{label:`Все сервисы`,onClick:()=>w(!0)}),account:(0,x.jsx)(f,{name:`Лаврентьев Александр`,job:`ООО “Сетл Тех”`,compact:c,menu:l,onMenuClick:e=>S(`кабинет → ${e}`)})}),(0,x.jsx)(`div`,{style:{marginTop:12,fontSize:12,color:`#7e7e7e`,fontFamily:`Inter, sans-serif`,minHeight:15},children:y?`Нажато: ${y}`:` `}),(0,x.jsx)(r,{size:`m`,side:!0,open:C,onClose:()=>w(!1),title:`Все сервисы`,children:(0,x.jsx)(`div`,{children:`Здесь спецмодалка, на которую ведёт круглая кнопка.`})})]})}var b,x,S,C,w,T,E,D,O,k,A,j,M;function N(){return(N=e((()=>{b=t(),s(),n(),_(),c(),u(),x=i(),S=`
