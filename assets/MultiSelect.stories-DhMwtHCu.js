import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n,t as r}from"./tooltip-D6AQNFSz.js";import{n as i,t as a}from"./select-BrgUlwm8.js";import{l as o,n as s,u as c}from"./iframe-CvEwutAq.js";import{Bl as l,Hl as u,Mn as d,t as f}from"./icons-BmsQWa6t.js";import{n as p,t as m}from"./DropdownMenuItem-C2PARjlA.js";import{n as h,t as g}from"./InputChrome-B-I71GFI.js";import{n as _,t as v}from"./SelectSpinner-DmozHHtV.js";import{n as y,t as b}from"./Select.module-D8niTVgo.js";import{n as x,t as S}from"./MultiSelectTag-Dam8ELnA.js";var C,w,T,E,D,O;function k(){return(k=e((()=>{C=`_multi_zbwue_4`,w=`_m_zbwue_3`,T=`_s_zbwue_3`,E=`_popup_zbwue_149`,D=`_omittedList_zbwue_179`,O={multi:C,m:w,s:T,popup:E,omittedList:D}})))()}function A({size:e=`m`,label:t,required:n,infoText:i,errorMessage:o,status:s,className:f,disabled:p,loading:h=!1,loadError:_=!1,onRetry:y,singleLine:x=!1,options:C,value:w,defaultValue:T,onChange:E,open:D,onOpenChange:k,placeholder:A,getPopupContainer:P,popupClassName:F,...I}){let[L,R]=(0,j.useState)(T??[]),z=w!==void 0,B=(z?w:L)??[],[V,H]=(0,j.useState)(!1),U=h||_,W=s===`error`||_,G=h?(0,M.jsx)(v,{}):_?(0,M.jsx)(`span`,{className:b.retryIcon,onClick:e=>{e.stopPropagation(),y?.()},children:(0,M.jsx)(d,{size:18})}):!U&&(D??V)?(0,M.jsx)(`span`,{className:b.arrowUp,children:(0,M.jsx)(l,{size:18})}):(0,M.jsx)(`span`,{className:b.arrowDown,children:(0,M.jsx)(u,{size:18})}),K=(0,M.jsx)(a,{...I,mode:`multiple`,showSearch:I.showSearch??!1,disabled:p,status:W?`error`:s,size:N[e],options:C,value:B,onChange:(e,t)=>{z||R(e),E?.(e,t)},open:!U&&D,onOpenChange:e=>{H(e),k?.(e)},placeholder:h?`Loading...`:A,suffixIcon:G,menuItemSelectedIcon:null,optionRender:e=>(0,M.jsx)(m,{mark:`checkbox`,label:e.label,selected:e.value!==void 0&&B.includes(e.value),disabled:e.data.disabled}),tagRender:({label:e,value:t,onClose:n,isMaxTag:r})=>r?(0,M.jsx)(M.Fragment,{children:e}):(0,M.jsx)(S,{disabled:p,onRemove:()=>n(),children:e},String(t)),maxTagCount:x?`responsive`:void 0,maxTagPlaceholder:e=>(0,M.jsx)(r,{color:c.tooltipBg,title:(0,M.jsx)(`div`,{className:O.omittedList,children:e.map(e=>(0,M.jsx)(`div`,{children:e.label},String(e.value)))}),children:(0,M.jsxs)(S,{disabled:p,children:[`+`,e.length]})}),getPopupContainer:P??(e=>e.closest(`[data-theme]`)??document.body),popupClassName:[O.popup,F].filter(Boolean).join(` `),className:[b.select,O.multi,O[e],h?b.loading:``,f].filter(Boolean).join(` `)});return(0,M.jsx)(g,{label:t,required:n,infoText:i,errorMessage:o,isError:W,disabled:p,field:K,valueTooltip:null})}var j,M,N;function P(){return(P=e((()=>{i(),n(),j=t(),f(),o(),p(),h(),y(),_(),k(),x(),M=s(),N={s:`small`,m:`middle`},A.__docgenInfo={description:``,methods:[],displayName:`MultiSelect`,props:{size:{required:!1,tsType:{name:`union`,raw:`'s' | 'm'`,elements:[{name:`literal`,value:`'s'`},{name:`literal`,value:`'m'`}]},description:``,defaultValue:{value:`'m'`,computed:!1}},label:{required:!1,tsType:{name:`ReactNode`},description:``},required:{required:!1,tsType:{name:`boolean`},description:``},infoText:{required:!1,tsType:{name:`string`},description:``},errorMessage:{required:!1,tsType:{name:`ReactNode`},description:``},loading:{required:!1,tsType:{name:`boolean`},description:`Спиннер + "Loading..." вместо шеврона; дропдаун временно не открывается.`,defaultValue:{value:`false`,computed:!1}},loadError:{required:!1,tsType:{name:`boolean`},description:`Не удалось загрузить опции — красная рамка + иконка рефреша; клик по ней вызывает onRetry.`,defaultValue:{value:`false`,computed:!1}},onRetry:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},singleLine:{required:!1,tsType:{name:`boolean`},description:`Теги в одну строку («Если нужно в 1 строку» в макете): не поместившиеся сворачиваются в «+N»
