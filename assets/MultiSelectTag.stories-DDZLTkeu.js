import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./MultiSelectTag-BPkXIaVr.js";function a(){let[e,t]=(0,o.useState)([`Пункт`,`Какой-то пункт`,`Длинный текст пункта`,`Норм пункт`]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:6,width:260},children:[e.map(e=>(0,s.jsx)(i,{onRemove:()=>t(t=>t.filter(t=>t!==e)),children:e},e)),e.length===0&&(0,s.jsx)(`span`,{style:{fontSize:12,opacity:.6},children:`Всё удалено`})]})}var o,s,c,l,u,d,f,p;function m(){return(m=e((()=>{o=t(),r(),s=n(),c={title:`UI Kit/Поля и выбор/MultiSelectTag`,id:`ui-kit-multiselecttag`,component:i,parameters:{layout:`padded`,docs:{description:{component:`
