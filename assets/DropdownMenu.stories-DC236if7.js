import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n}from"./iframe-r_k3QGfr.js";import{n as r,t as i}from"./Button-Dnmtfa_s.js";import{M as a,Pn as o,Wt as s,t as c,wi as l}from"./icons-CxwqsfdL.js";import{n as u,t as d}from"./DropdownMenu-NFsvRugK.js";function f(){let[e,t]=(0,p.useState)(``),n=[...v,{key:`e`,label:`Электромонтажные работы`},{key:`f`,label:`Отделочные работы`}].filter(t=>`type`in t||String(t.label).toLowerCase().includes(e.toLowerCase()));return(0,m.jsx)(d,{items:n,mark:`checkbox`,maxHeight:180,open:!0,popupRender:n=>(0,m.jsxs)(`div`,{children:[(0,m.jsx)(`div`,{style:{padding:8,paddingBottom:0},children:(0,m.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:`Поиск`,style:{width:`100%`,boxSizing:`border-box`,padding:`6px 12px`,borderRadius:4,border:`1px solid #dddddd`}})}),n]}),children:(0,m.jsx)(i,{variant:`secondary`,children:`Виды работ`})})}var p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N;function P(){return(P=e((()=>{p=t(),c(),r(),u(),m=n(),h=`
