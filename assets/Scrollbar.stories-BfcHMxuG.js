import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./jsx-runtime-DeHZSEgm.js";import{c as n,l as r}from"./iframe-BbKzeMWs.js";import{n as i,r as a,t as o}from"./Scrollbar-BzwgWClh.js";function s({size:e=`s`,style:t,children:n,asClassOnly:i=!1}){let{token:s}=r.useToken(),c={height:180,width:280,padding:12,border:`1px solid ${s.colorBorder}`,borderRadius:6,color:s.colorText,background:s.colorBgContainer,...t};return i?(0,l.jsx)(`div`,{className:a[e],style:{...c,overflowY:`auto`},children:n}):(0,l.jsx)(o,{size:e,style:c,children:n})}function c({suffix:e=``}){return(0,l.jsx)(l.Fragment,{children:d.map(t=>(0,l.jsxs)(`div`,{style:{padding:`6px 0`},children:[t,e]},t))})}var l,u,d,f,p,m,h,g,_,v;function y(){return(y=e((()=>{n(),i(),l=t(),u=`
