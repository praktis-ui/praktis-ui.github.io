import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{en as r,t as i}from"./icons-B1LEmBjt.js";import{n as a,t as o}from"./Input-AC4B0iwg.js";function s(){let[e,t]=(0,c.useState)(``),[n,r]=(0,c.useState)(!1),[i,a]=(0,c.useState)(``);return(0,c.useEffect)(()=>{if(!e)return;let t,n=setTimeout(()=>{r(!0),t=setTimeout(()=>{r(!1),a(e)},1e3)},400);return()=>{clearTimeout(n),clearTimeout(t),r(!1)}},[e]),(0,l.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:8,width:300},children:[(0,l.jsx)(o,{label:`ИНН`,placeholder:`Введите ИНН`,value:e,onChange:e=>t(e.target.value),loading:n}),(0,l.jsx)(`span`,{style:{fontFamily:`Inter, sans-serif`,fontSize:12,color:`#7e7e7e`},children:i?`проверено: ${i}`:`начни печатать`})]})}var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E;function D(){return(D=e((()=>{c=t(),i(),a(),l=n(),u={title:`UI Kit/Поля и выбор/Input`,id:`ui-kit-input`,component:o,parameters:{layout:`centered`,docs:{description:{component:`
