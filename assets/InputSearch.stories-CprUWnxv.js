import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{n}from"./iframe-CvEwutAq.js";import{n as r,t as i}from"./InputSearch-DH9_NFWd.js";function a(){let[e,t]=(0,o.useState)(!1),[n,r]=(0,o.useState)([]);return(0,s.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:8,width:300},children:[(0,s.jsx)(i,{placeholder:`Поиск по договорам`,loading:e,onSearch:e=>{r(t=>[...t,e||`(пусто)`]),t(!0),setTimeout(()=>t(!1),1500)}}),(0,s.jsx)(`span`,{style:{fontFamily:`Inter, sans-serif`,fontSize:12,color:`#7e7e7e`},children:n.length?`искали: ${n.join(`, `)}`:`введи текст и нажми Enter`})]})}var o,s,c,l,u,d,f,p,m,h,g,_;function v(){return(v=e((()=>{o=t(),r(),s=n(),c={title:`UI Kit/InputSearch`,component:i,parameters:{layout:`centered`,docs:{description:{component:`
